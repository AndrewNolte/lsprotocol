...
template <typename T>
void to_json(rapidjson::Value &v, const T &obj,
...
void serialize_member(rapidjson::Value &v, const T &obj, const char *name,
                      MemberPtr ptr,
                      rapidjson::Document::AllocatorType &allocator) {
...
template <typename T, typename MemberPtr>
void deserialize_member(const rapidjson::Value &v, T &obj, const char *name,
                        MemberPtr ptr) {
  if (v.HasMember(name)) {
