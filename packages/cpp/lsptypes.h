...
struct SignatureInformation {
    ...
    @since 3.16.0 */
    std::optional<std::optional<uint>> activeParameter;
};
...
struct _InitializeParams {
    ...
    std::optional<std::optional<std::string>> rootPath;
...
struct WorkspaceFoldersInitializeParams {
    ...
    @since 3.6.0 */
    std::optional<std::optional<std::vector<WorkspaceFolder>>> workspaceFolders;
};
...
struct WorkspaceEdit {
    ...
    std::optional<flat_hash_map<std::string, std::vector<TextEdit>>> changes;
    ...
    @since 3.16.0 */
    std::optional<flat_hash_map<std::string, ChangeAnnotation>>
            changeAnnotations;
};
