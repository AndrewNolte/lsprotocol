...
/// of its resource, or a glob-pattern that is applied to the {@link
...
struct CodeActionOptions {
    ...
    ///   provider has documentation for both `Refactor` and `RefactorExtract`,
    ///   when the user requests code actions for `RefactorExtract`, the editor
    ///   will use the documentation for `RefactorExtract` instead of the
