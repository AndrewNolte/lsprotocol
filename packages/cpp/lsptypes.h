...
struct RelativePattern {
    ...
    against relatively. */
    std::variant<WorkspaceFolder, std::string> baseUri;
...
@since 3.17.0 */
using NotebookDocumentFilter = std::variant<NotebookDocumentFilterNotebookType,
...
std::string_view toString(CodeActionKind value) {
    switch (value) {
        ...
        case CodeActionKind::RefactorMove:
...
@since 3.16.0 */
enum class FileOperationPatternKind : uint8_t {
    File,
    Folder,
};
std::string_view toString(FileOperationPatternKind value) {
    switch (value) {
...
'typescript', scheme: 'file' }`
@sample A language filter that applies to all package.json paths: `{ language:
'json', pattern: '**package.json' }`

@since 3.17.0 */
using TextDocumentFilter = std::variant<TextDocumentFilterLanguage,
...
std::string_view toString(MarkupKind value) {
    switch (value) {
...
enum class FoldingRangeKind : uint8_t {
    Comment,
    Imports,
    Region,
};
std::string_view toString(FoldingRangeKind value) {
    switch (value) {
...
std::string_view toString(LanguageKind value) {
    switch (value) {
        case LanguageKind::Abap:
            return "abap";
        case LanguageKind::WindowsBat:
            return "bat";
        case LanguageKind::BibTeX:
            return "bibtex";
        case LanguageKind::Clojure:
            return "clojure";
        case LanguageKind::Coffeescript:
            return "coffeescript";
        case LanguageKind::C:
            return "c";
        ...
        case LanguageKind::D:
            return "d";
        case LanguageKind::Delphi:
            return "pascal";
        case LanguageKind::Diff:
            return "diff";
        case LanguageKind::Dart:
            return "dart";
        case LanguageKind::Dockerfile:
            return "dockerfile";
        case LanguageKind::Elixir:
            return "elixir";
        case LanguageKind::Erlang:
            return "erlang";
        case LanguageKind::Fsharp:
            return "fsharp";
        case LanguageKind::GitCommit:
            return "git-commit";
        case LanguageKind::GitRebase:
            return "rebase";
        case LanguageKind::Go:
            return "go";
        case LanguageKind::Groovy:
            return "groovy";
        case LanguageKind::Handlebars:
            return "handlebars";
        case LanguageKind::Haskell:
            return "haskell";
        ...
        case LanguageKind::JavaScript:
            return "javascript";
        case LanguageKind::JavaScriptReact:
            return "javascriptreact";
        case LanguageKind::Json:
            return "json";
        case LanguageKind::LaTeX:
            return "latex";
        case LanguageKind::Less:
            return "less";
        case LanguageKind::Lua:
            return "lua";
        case LanguageKind::Makefile:
            return "makefile";
        case LanguageKind::Markdown:
            return "markdown";
        case LanguageKind::ObjectiveC:
            return "objective-c";
        case LanguageKind::ObjectiveCpp:
            return "objective-cpp";
        case LanguageKind::Pascal:
            return "pascal";
        case LanguageKind::Perl:
            return "perl";
        case LanguageKind::Perl6:
            return "perl6";
        case LanguageKind::Php:
            return "php";
        case LanguageKind::Powershell:
            return "powershell";
        case LanguageKind::Pug:
            return "jade";
        ...
        case LanguageKind::Rust:
            return "rust";
        case LanguageKind::Scss:
            return "scss";
        case LanguageKind::Sass:
            return "sass";
        case LanguageKind::Scala:
            return "scala";
        case LanguageKind::ShaderLab:
            return "shaderlab";
        case LanguageKind::ShellScript:
            return "shellscript";
        case LanguageKind::Sql:
            return "sql";
        case LanguageKind::Swift:
            return "swift";
        case LanguageKind::TypeScript:
            return "typescript";
        case LanguageKind::TypeScriptReact:
            return "typescriptreact";
        case LanguageKind::TeX:
            return "tex";
        case LanguageKind::VisualBasic:
            return "vb";
        case LanguageKind::Xml:
            return "xml";
        case LanguageKind::Xsl:
            return "xsl";
        case LanguageKind::Yaml:
            return "yaml";
        default:
            return "";
    }
...
std::string_view toString(ResourceOperationKind value) {
    switch (value) {
...
enum class FailureHandlingKind : uint8_t {
    Abort,
    Transactional,
    TextOnlyTransactional,
    Undo,
};
std::string_view toString(FailureHandlingKind value) {
    switch (value) {
...
struct ClientSemanticTokensRequestOptions {
    ...
    the server provides a corresponding handler. */
    std::variant<bool, ClientSemanticTokensRequestFullDelta> full;
};
...
enum class TokenFormat : uint8_t {
    Relative,
};
std::string_view toString(TokenFormat value) {
    switch (value) {
...
@since 3.17.0 */
enum class PositionEncodingKind : uint8_t {
    Utf8,
    Utf16,
    Utf32,
};
std::string_view toString(PositionEncodingKind value) {
    switch (value) {
...
struct ParameterInformation {
    ...
    instead of using a substring. Whether a client support this is controlled
    via `labelOffsetSupport` client capability.
    ...
    *Note*: a label of type string should be a substring of its containing
    ...
    std::variant<std::string, std::tuple<uint, uint>> label;
    /** The human-readable doc-comment of this parameter. Will be shown
    in the UI but can be omitted. */
    std::variant<std::string, MarkupContent> documentation;
};
...
@since 3.17.0 */
struct DiagnosticClientCapabilities : DiagnosticsCapabilities {
    /** Whether implementation supports dynamic registration. If this is set to
    `true` the client supports the new `(TextDocumentRegistrationOptions &
    StaticRegistrationOptions)` return value for the corresponding server
    capability as well. */
...
struct PublishDiagnosticsClientCapabilities : DiagnosticsCapabilities {
...
struct Diagnostic {
    ...
    std::variant<int, std::string> code;
...
struct NotebookDocumentSyncOptions {
    ...
    std::vector<std::variant<NotebookDocumentFilterWithNotebook,
...
enum class TextDocumentSyncKind : uint8_t {
    None = 0,
    Full = 1,
    Incremental = 2,
};
...
struct OptionalVersionedTextDocumentIdentifier : TextDocumentIdentifier {
    ...
    identifier is sent from the server to the client and the file is not open in
    the editor (the server has not received an open notification before) the
...
struct SignatureInformation {
    ...
    @since 3.16.0 */
    std::variant<uint, std::monostate> activeParameter;
};
...
struct TextDocumentRegistrationOptions {
    ...
    std::variant<DocumentSelector, std::monostate> documentSelector;
};
...
@since 3.18.0
@proposed */
struct TextDocumentContentRegistrationOptions : TextDocumentContentOptions {};
...
struct SemanticTokensOptions {
    ...
    std::variant<bool, SemanticTokensFullDelta> full;
};
...
struct TextDocumentSyncOptions {
    ...
    std::variant<bool, SaveOptions> save;
};
...
struct NotebookDocumentCellChanges {
    ...
    std::vector<NotebookDocumentCellContentChanges> textContent;
};
...
@since 3.17.0 */
struct InlayHintRegistrationOptions : InlayHintOptions,
...
struct CompletionItemLabelDetails {
    ...
    {@link CompletionItem.label label}, without any spacing. Should be used for
...
@since 3.17.0 */
struct DiagnosticRegistrationOptions : TextDocumentRegistrationOptions,
                                       DiagnosticOptions {};
...
struct TextDocumentEdit {
    ...
    client capability. */
    std::vector<std::variant<TextEdit, AnnotatedTextEdit, SnippetTextEdit>>
            edits;
};
...
@since 3.16.0 */
struct CallHierarchyRegistrationOptions : TextDocumentRegistrationOptions,
...
struct CodeActionOptions {
    ...
    editor will show the documentation that most closely matches the requested
    code action kind. For example, if a provider has documentation for both
    `Refactor` and `RefactorExtract`, when the user requests code actions for
    `RefactorExtract`, the editor will use the documentation for
    ...
    @since 3.18.0
    @proposed */
    std::vector<CodeActionKindDocumentation> documentation;
    /** The server provides support to resolve additional
...
/** @since 3.16.0 */
struct SemanticTokensRegistrationOptions : TextDocumentRegistrationOptions,
...
struct FoldingRangeRegistrationOptions : TextDocumentRegistrationOptions,
                                         FoldingRangeOptions {};
...
@since 3.17.0 */
struct InlineValueRegistrationOptions : InlineValueOptions,
                                        TextDocumentRegistrationOptions {};
...
struct MonikerRegistrationOptions : TextDocumentRegistrationOptions,
                                    MonikerOptions {};

struct TypeDefinitionRegistrationOptions : TextDocumentRegistrationOptions,
...
struct DeclarationRegistrationOptions : DeclarationOptions,
                                        TextDocumentRegistrationOptions {};

struct LinkedEditingRangeRegistrationOptions : TextDocumentRegistrationOptions,
...
@since 3.17.0 */
struct TypeHierarchyRegistrationOptions : TextDocumentRegistrationOptions,
...
enum class TraceValue : uint8_t {
    Off,
    Messages,
    Verbose,
};
std::string_view toString(TraceValue value) {
    switch (value) {
        case TraceValue::Off:
            return "off";
...
struct SelectionRangeRegistrationOptions : SelectionRangeOptions,
                                           TextDocumentRegistrationOptions {};

struct ImplementationRegistrationOptions : TextDocumentRegistrationOptions,
...
struct ServerCapabilities {
    ...
    std::variant<bool, HoverOptions> hoverProvider;
    ...
    std::variant<bool, DefinitionOptions> definitionProvider;
    ...
    std::variant<bool, ReferenceOptions> referencesProvider;
    /** The server provides document highlight support. */
    std::variant<bool, DocumentHighlightOptions> documentHighlightProvider;
    /** The server provides document symbol support. */
    std::variant<bool, DocumentSymbolOptions> documentSymbolProvider;
    /** The server provides code actions. CodeActionOptions may only be
    specified if the client states that it supports
    `codeActionLiteralSupport` in its initial `initialize` request. */
    std::variant<bool, CodeActionOptions> codeActionProvider;
    ...
    std::variant<bool, WorkspaceSymbolOptions> workspaceSymbolProvider;
    /** The server provides document formatting. */
    std::variant<bool, DocumentFormattingOptions> documentFormattingProvider;
    ...
    std::variant<bool, RenameOptions> renameProvider;
    ...
    @since 3.18.0
    @proposed */
    std::variant<bool, InlineCompletionOptions> inlineCompletionProvider;
...
struct CompletionItem {
    ...
    *Note 2:* If an `InsertReplaceEdit` is returned the edit's insert range
    ...
    std::variant<TextEdit, InsertReplaceEdit> textEdit;
    ...
    the same insert position) with the main {@link CompletionItem.textEdit edit}
    nor with themselves.
...
underlying document. An optional expression can be used to override the
...
If resource operations are present clients need to execute the operations in the
order in which they are provided. So a workspace edit for example can consist of
the following two changes: (1) a create file a.txt and (2) a text document edit
which insert text into file a.txt.
...
struct WorkspaceEdit {
    ...
    flat_hash_map<std::string, std::vector<TextEdit>> changes;
    ...
    @since 3.16.0 */
    flat_hash_map<std::string, ChangeAnnotation> changeAnnotations;
};
...
@since 3.16.0 */
enum class MonikerKind : uint8_t {
    Import,
    Export,
    Local,
};
std::string_view toString(MonikerKind value) {
    switch (value) {
        case MonikerKind::Import:
            return "import";
        case MonikerKind::Export:
            return "export";
        case MonikerKind::Local:
            return "local";
        default:
            return "";
    }
...
struct InlayHintLabelPart {
    ...
    std::variant<std::string, MarkupContent> tooltip;
...
struct _InitializeParams {
    ...
    std::variant<int, std::monostate> processId;
    /** Information about the client
    ...
    std::variant<std::string, std::monostate> rootPath;
    /** The rootUri of the workspace. Is null if no
    folder is open. If both `rootPath` and `rootUri` are set
    `rootUri` wins.

    @deprecated in favour of workspaceFolders. */
    std::variant<std::string, std::monostate> rootUri;
...
struct WorkspaceFoldersInitializeParams {
    ...
    @since 3.6.0 */
    std::variant<std::vector<WorkspaceFolder>, std::monostate> workspaceFolders;
};
...
struct CompletionItemDefaults {
    ...
    @since 3.17.0 */
    std::variant<Range, EditRangeWithInsertReplace> editRange;
...
markdown string or a code-block that provides a language and a code snippet. The
language identifier is semantically equal to the optional language identifier in
fenced code blocks in GitHub issues. See
https://help.github.com/articles/creating-and-highlighting-code-blocks/#syntax-highlighting
...
struct TypeHierarchyItem {
    ...
    and supertypes or subtypes requests. It could also be used to identify the
...
@since 3.16.0 */
enum class UniquenessLevel : uint8_t {
    Document,
    Project,
    Group,
    Scheme,
...
std::string_view toString(UniquenessLevel value) {
    switch (value) {
        case UniquenessLevel::Document:
            return "document";
        case UniquenessLevel::Project:
            return "project";
        case UniquenessLevel::Group:
            return "group";
        case UniquenessLevel::Scheme:
            return "scheme";
...
underlying document. An optional variable name can be used to override the
extracted name.
...
@since 3.17.0 */
using InlineValue = std::variant<InlineValueText,
...
than zero and smaller than the number of lines in the document. Clients are free
to ignore invalid ranges. */
struct FoldingRange {
    /** The zero-based start line of the range to fold. The folded area starts
    after the line's last character. To be valid, the end must be zero or larger
...
struct DocumentSymbol {
    ...
    used to determine if the clients cursor is inside the symbol to reveal in
...
using PrepareRenameResult = std::
        variant<Range, PrepareRenamePlaceholder, PrepareRenameDefaultBehavior>;
...
struct DidChangeTextDocumentParams {
    ...
    approach:
    - start with the same initial content
    - apply the 'textDocument/didChange' notifications in the order you receive
    them.
...
struct InitializeParams : _InitializeParams,
...
struct Hover {
    /** The hover's content */
    std::variant<MarkupContent, MarkedString, std::vector<MarkedString>>
            contents;
...
locations}. For most programming languages there is only one location at which a
symbol is defined.
...
struct DocumentLinkRegistrationOptions : TextDocumentRegistrationOptions,
                                         DocumentLinkOptions {};
...
struct DocumentSymbolRegistrationOptions : TextDocumentRegistrationOptions,
                                           DocumentSymbolOptions {};

/** Registration options for a {@link RenameRequest}. */
struct RenameRegistrationOptions : TextDocumentRegistrationOptions,
                                   RenameOptions {};

/** Registration options for a {@link SignatureHelpRequest}. */
struct SignatureHelpRegistrationOptions : TextDocumentRegistrationOptions,
                                          SignatureHelpOptions {};
...
struct CompletionRegistrationOptions : TextDocumentRegistrationOptions,
                                       CompletionOptions {};
...
@since 3.18.0
@proposed */
struct InlineCompletionRegistrationOptions : InlineCompletionOptions,
                                             TextDocumentRegistrationOptions {};
...
struct CodeLensRegistrationOptions : TextDocumentRegistrationOptions,
                                     CodeLensOptions {};
...
@since 3.17.0 */
enum class DocumentDiagnosticReportKind : uint8_t {
    Full,
    Unchanged,
};
std::string_view toString(DocumentDiagnosticReportKind value) {
    switch (value) {
...
struct DocumentHighlightRegistrationOptions : TextDocumentRegistrationOptions,
...
std::string_view toString(SemanticTokenModifiers value) {
    switch (value) {
...
struct HoverRegistrationOptions : TextDocumentRegistrationOptions,
                                  HoverOptions {};
...
struct DefinitionRegistrationOptions : TextDocumentRegistrationOptions,
                                       DefinitionOptions {};
...
struct DidChangeConfigurationRegistrationOptions {
    std::variant<std::string, std::vector<std::string>> section;
};

/** Registration options for a {@link DocumentFormattingRequest}. */
struct DocumentFormattingRegistrationOptions : TextDocumentRegistrationOptions,
...
std::string_view toString(SemanticTokenTypes value) {
    switch (value) {
...
struct CodeActionRegistrationOptions : TextDocumentRegistrationOptions,
                                       CodeActionOptions {};

/** Registration options for a {@link ReferencesRequest}. */
struct ReferenceRegistrationOptions : TextDocumentRegistrationOptions,
                                      ReferenceOptions {};
