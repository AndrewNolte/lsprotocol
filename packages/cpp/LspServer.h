...
protected: /// A request to resolve the range inside the workspace
           /// symbol's location.
           ///
           /// @since 3.17.0
    ...
    virtual std::optional<LSPAny> getWorkspaceExecuteCommand(const ExecuteCommandParams&) {
        return std::optional<LSPAny>{};
    }
